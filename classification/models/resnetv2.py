...
This file taken from : https://github.com/IntelLabs/AVUC/tree/main/models/deterministic
'''
import torch
...
def resnet20(nc=3,num_classes=10):
    return ResNet(BasicBlock, [3, 3, 3],nc=nc,num_classes=num_classes)
